...
import external_devices.gui_communication as gui_communication
...
class GuiCreation:
    ...
    def guiSetup(self):
        ...
        filterScales.append(Tkinter.Scale(frontProcessedImgFrame, from_ = 0, to = 300, width = 15, length=90)) #Creating sliders
        ...
        filterScales.append(Tkinter.Scale(bottomProcessedImgFrame, from_ = 0, to = 300, width = 15, length=90)) #Creating sliders
        ...
        #TAB 3 VHEICLE TESTS
        dvlButton = Tkinter.Button(tab3, text = "Doppler Velocity Log", font=("TkDefaultFont", int(round(screenRes[0]/176.667))), width = int(screenRes[0]/63.6), height = int(screenRes[1]/174), command = lambda: gui_communication.DvlControl(window).commInterface())
        dvlButton.grid(row = 0, column = 0, padx = int(screenRes[0]/79.5), pady = int(screenRes[1]/34.8))
        
        tcbButton = Tkinter.Button(tab3, text = "Thruster Control Board", font=("TkDefaultFont", int(round(screenRes[0]/176.667))), width = int(screenRes[0]/63.6), height = int(screenRes[1]/174), command = lambda: gui_communication.TcbControl(window).commInterface())
        tcbButton.grid(row = 1, column = 0, padx = int(screenRes[0]/79.5), pady = int(screenRes[1]/34.8))
        
        hydraButton = Tkinter.Button(tab3, text = "Hydra Board", font=("TkDefaultFont", int(round(screenRes[0]/176.667))), width = int(screenRes[0]/63.6), height = int(screenRes[1]/174), command = lambda: gui_communication.Hydra_Board(window).commInterface())
        hydraButton.grid(row = 2, column = 0, padx = int(screenRes[0]/79.5), pady = int(screenRes[1]/34.8))
        
        spartonButton = Tkinter.Button(tab3, text = "Sparton AHRS", font=("TkDefaultFont", int(round(screenRes[0]/176.667))), width = int(screenRes[0]/63.6), height = int(screenRes[1]/174), command = lambda: gui_communication.Sparton_AHRS(window).commInterface())
        spartonButton.grid(row = 0, column = 1, padx = int(screenRes[0]/79.5), pady = int(screenRes[1]/34.8))
        
        spartonButton = Tkinter.Button(tab3, text = "PNI AHRS", font=("TkDefaultFont", int(round(screenRes[0]/176.667))), width = int(screenRes[0]/63.6), height = int(screenRes[1]/174), command = lambda: gui_communication.PNI_AHRS(window).commInterface())
        spartonButton.grid(row = 1, column = 1, padx = int(screenRes[0]/79.5), pady = int(screenRes[1]/34.8))
        
        spartonButton = Tkinter.Button(tab3, text = "Weapons Control Board", font=("TkDefaultFont", int(round(screenRes[0]/176.667))), width = int(screenRes[0]/63.6), height = int(screenRes[1]/174), command = lambda: gui_communication.Weapons_Control_Board(window).commInterface())
        spartonButton.grid(row = 2, column = 1, padx = int(screenRes[0]/79.5), pady = int(screenRes[1]/34.8))
        
        pmudButton = Tkinter.Button(tab3, text = "Power Monitoring Board", font=("TkDefaultFont", int(round(screenRes[0]/176.667))), width = int(screenRes[0]/63.6), height = int(screenRes[1]/174),command = lambda: gui_communication.Power_Monitoring_Board(window).commInterface())
        pmudButton.grid(row = 0, column = 2, padx = int(screenRes[0]/79.5), pady = int(screenRes[1]/34.8))
