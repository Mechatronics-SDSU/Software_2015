...
DVLPort = serial.Serial("COM9", 115200)

#DVL WAKE UP
DVLPort.write(bytearray(['+', '+', '+'])), time.sleep(2) #Sends Break and waits for 2 seconds for DVL to wake up.
...
while True:
    if DVLPort.inWaiting() != 0:
        ...
        if ID == "0x7d":
            ...
            print "Positions(mm) (East, North, Up, Error)", eastPosition, northPosition, upPosition, positionError
