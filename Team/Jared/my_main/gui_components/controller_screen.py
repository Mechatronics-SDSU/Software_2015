...
class controller():
    ...
    def run(self):
        ...
        try:           
            if self.window.externalDevicesData[2][0] == False:
                ...
                name = self.window.externalDevicesData[2][0]
                ...
                axes = self.window.externalDevicesData[2][1]
                ...
                buttons = self.window.externalDevicesData[2][2]
                ...
                hats = self.window.externalDevicesData[2][3]
