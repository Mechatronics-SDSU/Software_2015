...
class DataPacket:
    ...
    def calcCRC16In(self, dataPacket): #For AHRS
        ...
        * **dataPacket** - The complete data packet\n
        ...
        if dataPacket != [0] and dataPacket != None:
            ...
            try:
                checksum = CRC16(str(bytearray(dataPacket[0:len(dataPacket)-3])))
                CRCIn = dataPacket[-3] << 8 | dataPacket[-2] << 0
    ...
    def calcCRC32Out(self): #For F0, F4
        ...
        * **No Return.**\n
        ...
        self.crc = [checksumToInts[0], checksumToInts[1], checksumToInts[2], checksumToInts[3]]
        ...
        * **dataPacket** - The complete data packet.\n
        ...
        if dataPacket != [0] and dataPacket != None:
            ...
            try:
                ...
                CRCIn = dataPacket[-4] << 24 | dataPacket[-3] << 16 | dataPacket[-2] << 8 | dataPacket[-1] << 0
