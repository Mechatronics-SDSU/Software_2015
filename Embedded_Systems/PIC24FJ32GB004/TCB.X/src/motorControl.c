...
static const uint8 directionPin[MOTOR_COUNT] = {2, 0, 4, 9};
static volatile uint16* const directionReg[MOTOR_COUNT] = { &LATB, &LATC, &LATC, &LATA };
static volatile uint16* const dutyCycleReg[MOTOR_COUNT] = { &OC2R, &OC5R, &OC3R, &OC4R };
