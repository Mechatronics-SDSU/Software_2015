...
{
    PACKETFRAMEID_INTTEMPGET = 0x6D,
    PACKETFRAMEID_INTPRESGET = 0x6E,
    PACKETFRAMEID_EXTPRESGET = 0x6F
};
...
enum PacketComStateEnum
{
    ...
    PACKETSTATE_PARSEINTTEMPGET,
    PACKETSTATE_PARSEINTPRESGET,
    PACKETSTATE_PARSEEXTPRESGET
};
