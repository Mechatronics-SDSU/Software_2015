...
class removeWaypoint():
    ...
    def modify(self, *event):
        ...
        * **No Return.**\n
        ...
        self.northEntry.insert(0, str(n))
        ...
        self.positionEntry.insert(0, str(pE))
        ...
        self.pitchEntry.insert(0, str(p))
        ...
        self.depthEntry.insert(0, str(d))
        ...
        * **No Return.**\n
        ...
        if window.quitFlag:
            ...
            if not window.DEBUG:
                ...
                self.parent_conn.send([mainProcessReadyFlag, window.startVehicle, turnOffDirtyPower, window.manualModeEnabled, None, None, setWaypointToggle, removeWaypointToggle, window.resetDVL])
            ...
            if not window.DEBUG:
                ...
                self.parent_conn.send([mainProcessReadyFlag, window.startVehicle, turnOffDirtyPower, window.manualModeEnabled, missionSelectorData, imageProcValues, setWaypointToggle, removeWaypointToggle, window.resetDVL])
    ...
    def guiSetup(self):
        ...
        * **No Return.**\n
        ...
        for port in available_ports:
            ...
            elif port[2] == 'FTDIBUS\\VID_0403+PID_6001+FTG5PLGLA\\0000':
